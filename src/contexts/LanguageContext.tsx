...
const translations = {
  en: {
    ...
    'contact.subtitle': 'Get in touch with us for any inquiries or feedback',
    'contact.sendMessage': 'Send us a Message',
    'contact.contactInfo': 'Contact Information',
    'contact.address': 'Our Location',
    'contact.addressLine1': '123 Flour Mill Lane',
    'contact.addressLine2': 'New Delhi, 110001, India',
    'contact.phone': 'Phone',
    'contact.email': 'Email',
  ...
  hi: {
    ...
    'contact.subtitle': 'किसी भी प्रश्न या प्रतिक्रिया के लिए हमसे संपर्क करें',
    'contact.sendMessage': 'हमें एक संदेश भेजें',
    'contact.contactInfo': 'संपर्क जानकारी',
    'contact.address': 'हमारा पता',
    'contact.addressLine1': '123 आटा मिल मार्ग',
    'contact.addressLine2': 'नई दिल्ली, 110001, भारत',
    'contact.phone': 'फोन',
    'contact.email': 'ईमेल',
